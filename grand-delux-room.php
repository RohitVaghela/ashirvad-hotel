<?php
$pageName = "Grand Delux Room";
$metaKeywords = "Grand Deluxe Room Jamnagar, Ashirwad Club Resort rooms, luxury hotel rooms Jamnagar, deluxe resort accommodation, best deluxe room Jamnagar, hotel room with modern amenities, Ashirwad resort room rates, grand deluxe stay Jamnagar";
$metaDescription = "Experience refined comfort in our Grand Deluxe Room at Ashirwad Club & Resort, Jamnagar. Enjoy spacious interiors, modern amenities, elegant décor, and serene views — perfect for families, couples, or business travelers seeking luxury and relaxation.";
$metaImage = "";
$articleSection = '';
$articleTag = '';
...
<body>
    ...
    <section class="cs_page_heading_2 cs_primary_bg cs_bg_filed" data-src="assets/img/home/room-1.webp">
        <div class="container">
            <div class="cs_page_heading_in">
                <div class="">
                    <h1 class="cs_white_color mb-0 cs_fs_67">Grand Delux Room</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index">Home</a></li>
                        <!-- <li class="breadcrumb-item"><a href="rooms.html">Rooms</a></li> -->
                        <li class="breadcrumb-item active">Grand Delux Room</li>
                    </ol>
                </div>
                <!-- <div class="cs_page_heading_right">
                    <p>Price per night</p>
                    <h1 class="cs_white_color mb-0 cs_fs_67">$320.0</h1>
                </div> -->
            </div>
        </div>
    </section>
    ...
    <div class="container">
            ...
            <div class="col-9">
                <div class="position-relative overflow-hidden cs_radius_5 cs_gallery_hover_show_nav cs_primary_bg">
                    <div class="cs_gallery_slider_thumb slick-slider">
                        ...
                        <div class="cs_gallery_slider_thumb_item">
                            <img src="assets/img/home/room-6.webp" alt="room-6">
                        </div>
                    </div>
        ...
        <div class="row cs_gap_y_40">
            <div class="col-lg-6">
                <h3 class="cs_fs_38 cs_mb_29 cs_mb_lg_20">Overview</h3>
            ...
            <div class="col-lg-6">
                <h3 class="cs_fs_38 cs_mb_29 cs_mb_lg_20">Features</h3>
    ...
    <!-- <section>
        ...
        <div class="container">
            <div class="cs_section_heading cs_style_1 text-center">
                <p class="cs_section_subtitle cs_medium cs_letter_spacing_1 cs_mb_28 cs_mb_lg_15 text-uppercase">Why CHOOSE Ashirwad Hotels & Resorts</p>
            ...
            <div class="row cs_row_gap_50 cs_gap_y_75">
                <div class="col-lg-4 col-md-6">
                    <div class="cs_iconbox cs_style_1">
                        ...
                        <h3 class="cs_iconbox_title cs_mb_19 cs_fs_38">Restaurant &amp;</h3>
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                                <a href="room-details.html" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                                    <img src="assets/img/room_4.jpeg" alt="Room">
                                ...
                                <div class="cs_card_info position-relative">
                                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="room-details.html">Grand Delux Room</a></h2>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                                ...
                                <div class="cs_card_info position-relative">
                                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="room-details.html">Suite Room</a></h2>
                                    <!-- <div class="cs_card_price cs_mb_17">
                                        <span class="cs_primary_color">From</span>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                                <a href="room-details.html" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                                    <img src="assets/img/room_6.jpeg" alt="Room">
                                    <span class="cs_card_btn position-absolute cs_zindex_2">
                                        <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                                            <b>Details View</b>
                                            <span>
                                ...
                                <div class="cs_card_info position-relative">
                                    <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="grand-delux-room.php">Grand Deluxe Room</a></h2>
                                    <!-- <div class="cs_card_price cs_mb_17">
                                        <span class="cs_primary_color">From</span>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                                <a href="room-details.html" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                                    <img src="assets/img/room_22.jpeg" alt="Room">
                                    <span class="cs_card_btn position-absolute cs_zindex_2">
                                        <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                                            <b>Details View</b>
                                            <span>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                                <a href="room-details.html" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                                    <img src="assets/img/room_23.jpeg" alt="Room">
                                    <span class="cs_card_btn position-absolute cs_zindex_2">
                                        <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                                            <b>Details View</b>
                                            <span>
                        ...
                        <div class="cs_slide">
                            <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                                <a href="room-details.html" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                                    <img src="assets/img/room_24.jpeg" alt="Room">
                                    <span class="cs_card_btn position-absolute cs_zindex_2">
                                        <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                                            <b>Details View</b>
                                            <span>
